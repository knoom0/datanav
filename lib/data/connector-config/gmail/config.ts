  ...
  dataLoaderFactory: () => new GoogleAPIDataLoader({
    ...
    onFetch: async function* ({
      ...
      while (hasMorePages) {
        ...
        // First, get the list of message IDs using non-batch client
        ...
        for (let chunkIndex = 0; chunkIndex < messageChunks.length; chunkIndex++) {
          ...
          // Yield successful responses and track latest message date
        ...
        logger.info("Processed Gmail messages page");
      }
    },
  })
